...
public class UpdatePerson extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.txtEmail=(EditText) this.findViewById(R.id.editText2);
		this.txtContact=(EditText) this.findViewById(R.id.editText3);
	...
	public void onClick(View arg0) {
		...
		case R.id.button1: //save
			...
			String contact=this.txtContact.getText().toString();
			
			if(uri!=null && !name.equals("") && !email.equals("") && !contact.equals("") ){
				intent =new Intent();
