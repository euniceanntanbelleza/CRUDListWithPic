...
public class ItemAdapter extends BaseAdapter {
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if(arg1==null){
			...
			handler.email=(TextView) arg1.findViewById(R.id.textView2);
			handler.contact=(TextView) arg1.findViewById(R.id.textView3);
			arg1.setTag(handler);
		...
		handler.email.setText(list.get(arg0).getEmail());
